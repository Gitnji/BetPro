        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center"><i class="fas fa-check text-accent mr-2"></i> 2 premium tips daily</li>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 border-2 border-accent relative">
                    ...
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center"><i class="fas fa-check text-accent mr-2"></i> 5 premium tips daily</li>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center"><i class="fas fa-check text-accent mr-2"></i> 10 premium tips daily</li>
