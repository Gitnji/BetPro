                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">john@example.com</td>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full">
            <div class="p-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="index.html" onclick="confirmLogout()" class="text-center justify-center flex-1 bg-red-600 text-white py-3 rounded-lg font-semibold hover:bg-red-700 transition-all duration-200">logout</a>
                </div>
            </div>
        </div>
    </div>
