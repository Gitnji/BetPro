...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center transition-colors duration-300 px-4 py-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            <form class="space-y-6" id="register-form" action="#" method="POST">
                <div class="space-y-5">
                    <div>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="login.html" class="text-primary hover:text-opacity-80 font-semibold transition-colors">
                            Sign in
                        </a>
                    </p>
                </div>
        ...
        <!-- Back to Home -->
        <div class="text-center">
            <a href="index.html" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors inline-flex items-center">
